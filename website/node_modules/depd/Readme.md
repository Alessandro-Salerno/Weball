...
This library allows you to display deprecation messages to your customers.
...
customers of all deprecated uses across the code base, rather than just
...
on different situations and the customers will still get all the warnings:
